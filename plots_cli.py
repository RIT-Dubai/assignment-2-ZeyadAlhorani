...
def class_average_calculation():
    ...
    plotter.new_series()
    plotter.add_data_point(69.29)
    plotter.new_series()
    plotter.add_data_point(54.43)
    plotter.new_series()
    plotter.add_data_point(42.72)
    plotter.new_series()
    plotter.add_data_point(69.29)
    plotter.new_series()
    plotter.add_data_point(44.73)
    plotter.new_series()
    plotter.add_data_point(52.52)
    plotter.new_series()
    plotter.add_data_point(34.71)
    plotter.new_series()
    plotter.add_data_point(62.29)
    plotter.new_series()
    plotter.add_data_point(62.29)
    plotter.new_series()
    plotter.plot(trace_plot=True)
